...
const firebaseConfig = require('../src/firebase/config').default;
...
// Main function to run all the add operations
async function addAllRewards() {
  try {
